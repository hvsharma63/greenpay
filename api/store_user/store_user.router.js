...
const { createStoreValidationRules, updateStoreValidationRules, validate } = require('./../../auth/validation')
...
router.patch("/update_store", checkToken, updateStoreValidationRules(), validate, updateStore);
router.delete("/delete_store", checkToken, deleteStore);
